...
public:
	...
	t_twinkle_rtp_session(const InetHostAddress &host,string,unsigned short);
	t_twinkle_rtp_session(const InetHostAddress &host, unsigned short port,string,unsigned short);
