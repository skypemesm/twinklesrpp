...
#else
t_twinkle_rtp_session::t_twinkle_rtp_session(const InetHostAddress &host,string dst_host,unsigned short dst_port) :
	SymmetricRTPSession(host,dst_host,dst_port)
{
}

t_twinkle_rtp_session::t_twinkle_rtp_session(const InetHostAddress &host, unsigned short port,string dst_host,unsigned short dst_port) :
	SymmetricRTPSession(host, port,dst_host,dst_port)
{
}
#endif
